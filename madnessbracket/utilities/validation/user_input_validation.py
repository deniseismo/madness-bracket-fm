...
def validate_lastfm_user_input(user_input: ImmutableMultiDict) -> Optional[LastFMUserInput]:
    """
...
def validate_artist_user_input(user_input: ImmutableMultiDict) -> Optional[ArtistUserInput]:
    """
...
def validate_artists_battle_user_input(user_input: ImmutableMultiDict) -> Optional[ArtistsBattleUserInput]:
    """
...
def validate_bracket_upper_limit(user_input: ImmutableMultiDict) -> Optional[int]:
    """
